...
## For Vuejs
```
import ClassicEditor from '@niklaus-mikael/ckeditor5-custom-build'
 ...
 mounted() {
      ...
      .then(editor=>console.log("editor initiated))
...
You can create an issue on https://github.com/ckeditor/ckeditor5/issues including the build id - `z81zvcuaqp3i-ub8o41beeasa`. Make sure that the question / problem is unique, please look for a possibly asked questions in the search box. Duplicates will be closed.
